...
class SslCommerzPaymentController extends Controller
{
    ...
    public function success(Request $request)
    {
        ...
        // Fetch cart items
        $carts = Cart::with('product:id,price,selling_price')
        ...
        foreach ($carts as $cart) {
            ...
            // Delete the cart item after saving the order item
            $cart->delete();
        }
        ...
        if ($order_details->status == 'Pending') {
            ...
            if ($validation) {
                ...
                // After logging in, you can access the customer's ID like this:
                Auth::guard('customer')->id();  // This will give you the customer's ID

                return redirect()->route('profile.show')->with('success', 'Transaction is successfully completed.');
            } else {
                return redirect()->route('checkout')->with('error', 'Payment validation failed.');
            }
        } else if ($order_details->status == 'Processing' || $order_details->status == 'Complete') {
            return redirect()->route('checkout')->with('success', 'Transaction is already completed.');
        } else {
