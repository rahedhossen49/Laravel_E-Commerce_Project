                                ...
                                <div class="slide-action">
                                    ...
                                    <div class="item-rating">
                                        <div class="thumb">
                                            <ul>
                                                <li><img
                                                        src="{{ asset('Frontend/assets/images/others/author1.png" alt="Author') }}">
                                                </li>
                                                <li><img
                                                        src="{{ asset('Frontend/assets/images/others/author2.png" alt="Author') }}">
                                                </li>
                                                <li><img
                                                        src="{{ asset('Frontend/assets/images/others/author3.png" alt="Author') }}">
                                                </li>
                                                <li><img
                                                        src="{{ asset('Frontend/assets/images/others/author4.png" alt="Author') }}">
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="content">
                        ...
                        <div class="slick-single-layout">
                            <div class="categrie-product" data-sal="zoom-out" data-sal-delay="200"
                                ...
                                <a href="{{ route('frontend.category.show', $category->slug) }}">
                                    <img class="img-fluid" style="max-height:41px"
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        ...
                                        <div class="label-block label-right"></div>
                                    ...
                                    <div class="product-content">
                                        <div class="inner text-center">
                                            <h5 class="title"><a href="single-product.html">{{ $product->title }}</a>
                                            </h5>
                                            <div class="product-price-variant">
                                                @if ($product->selling_price)
                                                    <span class="price current-price">{{ $product->selling_price }}
                                                        Taka</span>
                                                @else
                            ...
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="zoom-out" data-sal-delay="200" data-sal-duration="500"
                                        src="{{ asset('Frontend/assets/images/product/electric/p') }}roduct-05.png"
                                        alt="Product Images">
                                </a>
                            ...
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="zoom-out" data-sal-delay="300" data-sal-duration="500"
                                        src="{{ asset('Frontend/assets/images/product/electric/p') }}roduct-06.png"
                                        alt="Product Images">
                                </a>
                            </div>
                            <div class="product-content">
                            ...
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="zoom-out" data-sal-delay="400" data-sal-duration="500"
                                        src="{{ asset('Frontend/assets/images/product/electric/p') }}roduct-07.png"
                                        alt="Product Images">
                                </a>
                                <div class="label-block label-right">
                            ...
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="zoom-out" data-sal-delay="500" data-sal-duration="500"
                                        src="{{ asset('Frontend/assets/images/product/electric/p') }}roduct-08.png"
                                        alt="Product Images">
                                </a>
                                <div class="label-block label-right">
                            ...
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="zoom-out" data-sal-delay="100" data-sal-duration="500"
                                        src="{{ asset('Frontend/assets/images/product/electric/p') }}roduct-04.png"
                                        alt="Product Images">
                                </a>
                                <div class="label-block label-right">
                            ...
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="zoom-in" data-sal-delay="100" data-sal-duration="1500"
                                        src="{{ asset('Frontend/assets/images/product/electric/p') }}roduct-09.png"
                            ...
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="zoom-in" data-sal-delay="200" data-sal-duration="1500"
                                        src="{{ asset('Frontend/assets/images/product/electric/p') }}roduct-10.png"
                                        alt="Yantiti Leather Bags">
                                </a>
                            </div>
                            <div class="product-content">
                            ...
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="zoom-in" data-sal-delay="300" data-sal-duration="1500"
                                        src="{{ asset('Frontend/assets/images/product/electric/p') }}roduct-11.png"
                                        alt="Yantiti Leather Bags">
                                </a>
                            </div>
                            <div class="product-content">
                            ...
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="zoom-in" data-sal-delay="400" data-sal-duration="1500"
                                        src="{{ asset('Frontend/assets/images/product/electric/p') }}roduct-12.png"
                                        alt="Yantiti Leather Bags">
                                </a>
                            </div>
                            <div class="product-content">
                            ...
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="zoom-in" data-sal-delay="500" data-sal-duration="1500"
                                        src="{{ asset('Frontend/assets/images/product/electric/p') }}roduct-13.png"
                                        alt="Yantiti Leather Bags">
                                </a>
                            </div>
                            <div class="product-content">
                            ...
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="zoom-in" data-sal-delay="600" data-sal-duration="1500"
                                        src="{{ asset('Frontend/assets/images/product/electric/p') }}roduct-14.png"
                                        alt="Yantiti Leather Bags">
                                </a>
                            </div>
                            <div class="product-content">
                    ...
                    <div class="col">
                        <div class="axil-product-list">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="zoom-in" data-sal-delay="400" data-sal-duration="1500"
                                        src="{{ asset('Frontend/assets/images/product/electric/p') }}roduct-15.png"
                                        alt="Yantiti Leather Bags">
                                </a>
                            </div>
                            <div class="product-content">
                    ...
                    <div class="col">
                        <div class="axil-product-list">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="zoom-in" data-sal-delay="500" data-sal-duration="1500"
                                        src="{{ asset('Frontend/assets/images/product/electric/p') }}roduct-16.png"
                                        alt="Yantiti Leather Bags">
                                </a>
                            </div>
                            <div class="product-content">
            ...
            <div class="row">
                <div class="col-lg-6 mb--30">
                    <div class="single-poster">
                        <a href="shop.html">
                            <img src="{{ asset('Frontend/assets/images/product/poster/pos') }}ter-01.png"
                ...
                <div class="col-lg-6 mb--30">
                    <div class="single-poster">
                        <a href="shop-sidebar.html">
                            <img src="{{ asset('Frontend/assets/images/product/poster/pos') }}ter-02.png"
                                alt="eTrade promotion poster">
