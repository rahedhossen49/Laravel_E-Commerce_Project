    ...
    <div class="row">
        <div class="col-md-4 order-md-2 mb-4">
            <h4 class="d-flex justify-content-between align-items-center mb-3">
                ...
                <span class="badge badge-secondary bad ge-pill">{{$carts->count()}}</span>
            </h4>
            ...
            <form action="{{ url('/pay') }}" method="POST" class="needs-validation">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="customer_mobile" class="form-control" id="mobile" placeholder="Mobile"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="address" placeholder="1234 Main St"
                           value="{{auth('customer')->user()?->address}}" name="address" >
                    <div class="invalid-feedback">
                ...
                <hr class="mb-4">
                <button class="btn btn-primary btn-lg btn-block" type="submit">Pay With SSL Commerze</button>
            </form>
        </div>
    </div>
