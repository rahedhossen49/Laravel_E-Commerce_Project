            ...
            <div class="container">
                <div class="axil-dashboard-warp">
                    <div class="axil-dashboard-author">
                        <div class="media">
                            <div class="thumbnail">
                                <img style="height: 80px" src="{{getProfileImage('customer')}}" alt="Hello {{auth('customer')->user()->name}}">
                            </div>
                            ...
                            <aside class="axil-dashboard-aside">
                                <nav class="axil-dashboard-nav">
                                    <div class="nav nav-tabs" role="tablist">
                                        ...
                                        <a class="nav-item nav-link" href="{{route('customer.signOut')}}"><i class="fal fa-sign-out"></i>Logout</a>
                                    </div>
                                </nav>
                            </aside>
                        </div>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="nav-dashboard" role="tabpanel">
                                    <div class="axil-dashboard-overview">
                                        <div class="welcome-text">Hello {{auth('customer')->user()->name}} (not <span>{{auth('customer')->user()->name}}?</span> <a href="{{route('customer.signOut')}}">Log Out</a>)</div>
