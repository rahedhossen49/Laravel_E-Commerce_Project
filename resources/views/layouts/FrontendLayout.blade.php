                ...
                <div class="header-navbar">
                    ...
                    <style>
                        ...
                        .menu-item-has-children>ul.axil-submenu {
                            ...
                            position: absolute;
                            top: 100%;
                            /* Show right below the parent item */
                            left: 0;
                        ...
                        .menu-item-has-children ul.axil-submenu ul.axil-submenu {
                            left: 100%;
                            /* Sub-submenu goes to the right of parent */
                            top: 0;
                        }
                                ...
                                <li class="menu-item-has-children">
                                    ...
                                    <ul class="axil-submenu">
                                        ...
                                        @foreach ($categories as $category)
                                            <li
                                                class="menu-item{{ count($category->subcategories) > 0 ? ' menu-item-has-children' : '' }}">
                                                <a
                                                    href="{{ route('frontend.category.show', $category->slug) }}">{{ $category->title }}</a>
                                                ...
                                                @if (count($category->subcategories) > 0)
                                                    <ul class="axil-submenu">
                                                        @foreach ($category->subcategories as $subcategory)
                                                            <li><a
                                                                    href="{{ route('frontend.category.show', $subcategory->slug) }}">{{ $subcategory->title }}</a>
                                                            </li>
                                                        @endforeach
                                                    </ul>
                                                @endif
                        ...
                        <div class="axil-footer-widget">
                            ...
                            <div class="inner">
                                ...
                                <div class="download-btn-group">
                                    ...
                                    <div class="app-link">
                                        <a href="index-1.html#">
                                            <img src="{{ asset('Frontend/assets/images/others/app-store.p') }}ng"
                                                alt="App Store">
                                        </a>
                                        <a href="index-1.html#">
                                ...
                                <div class="row">
                                    <div class="col-lg-10 order-lg-2">
                                        <div
                                            ...
                                            <div class="thumbnail">
                                                <img src="{{ asset('Frontend/assets/images/product/product-bi') }}g-01.png"
                                                    alt="Product Images">
                                            ...
                                            <div class="thumbnail">
                                                <img src="{{ asset('Frontend/assets/images/product/product-bi') }}g-02.png"
                                                    alt="Product Images">
                                                <div class="label-block label-right">
                                                    <div class="product-badget">20% OFF</div>
                                                </div>
                                            ...
                                            <div class="thumbnail">
                                                <img src="{{ asset('Frontend/assets/images/product/product-bi') }}g-03.png"
                                                    alt="Product Images">
                                                <div class="label-block label-right">
                                                    <div class="product-badget">20% OFF</div>
                                                </div>
                                    ...
                                    <div class="col-lg-2 order-lg-1">
                                        <div class="product-small-thumb small-thumb-wrapper">
                                            <div class="small-thumb-img">
                                                <img src="{{ asset('Frontend/assets/images/product/product-th') }}umb/thumb-08.png"
                                                    alt="thumb image">
                                            </div>
                                            <div class="small-thumb-img">
                                                <img src="{{ asset('Frontend/assets/images/product/product-th') }}umb/thumb-07.png"
                                                    alt="thumb image">
                                            </div>
                                            <div class="small-thumb-img">
                                                <img src="{{ asset('Frontend/assets/images/product/product-th') }}umb/thumb-09.png"
                                                    alt="thumb image">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="inner">
                                        <div class="product-rating">
                                            <div class="star-rating">
                                                <img src="{{ asset('Frontend/assets/images/icons/rate.png" al') }}t="Rate
                                                    Images">
                                            </div>
